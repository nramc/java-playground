...
class SumDigitsPowerTest {
    ...
    private static void testing(long a, long b, long[] res) {
        assertEquals(Arrays.toString(res),
                Arrays.toString(SumDigitsPower.sumDigPow(a, b).toArray()));
    }

    @Test
    void test_isEqualOfSumOfPowOfDigits() {
        assertTrue(SumDigitsPower.isEqualOfSumOfPowOfDigits(135));
    }
